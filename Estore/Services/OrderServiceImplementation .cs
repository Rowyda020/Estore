...
namespace Estore.Services
{
    public class OrderServiceImplementation : OrderService.OrderServiceBase
    {
        ...
        public override async Task<OrderResponse> ProcessOrder(Protos.OrderRequest request, ServerCallContext context)
        {
            var inventoryResponse = await _inventoryService.DeductInventoryAsync(
            ...
            var paymentResponse = await _paymentService.ProcessPaymentAsync(
                request.ClientId, request.Quantity * request.Price);
